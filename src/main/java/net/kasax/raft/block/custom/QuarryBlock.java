...
public class QuarryBlock extends Block implements BlockEntityProvider {
    ...
    public void appendTooltip(ItemStack stack, Item.TooltipContext context, List<Text> tooltip, TooltipType options) {
        tooltip.add(Text.translatable("tooltip.raft.quarry.tooltip1").formatted(Formatting.AQUA));
        tooltip.add(Text.translatable("tooltip.raft.quarry.tooltip2").formatted(Formatting.AQUA));
